...
/datum/species/nabber
	...
	eyes_icon = 'modular_zfen/code/modules/organs/icons/nabber_eyes.dmi'
	can_augment = FALSE
	veteran_only = FALSE
	species_traits = list(
		MUTCOLORS,
	...
	payday_modifier = 1 //We don't engage in specism, good sir.
...
/datum/species/nabber/create_pref_unique_perks()
	...
	perk_descriptions += list(list(
		...
		SPECIES_PERK_NAME = "Natural Armor",
		SPECIES_PERK_DESC = "Giant Armoured Serpentids have extremely thick natural armor - this provides them a great deal of base protection against ballistic weaponry and sharp objects, but comes with the inability to wear MODsuits, Armor and generally does not protect very well against burns!"
	))

	perk_descriptions += list(list(
		SPECIES_PERK_TYPE = SPECIES_POSITIVE_PERK,
		SPECIES_PERK_ICON = "star-of-life",
		SPECIES_PERK_NAME = "Heavy Body",
		SPECIES_PERK_DESC = "A Giant Armoured Serpentid - as its name suggests - is Giant and Armoured. They are exceptionally heavy and cannot be easily grabbed.."
	))

	perk_descriptions += list(list(
		SPECIES_PERK_TYPE = SPECIES_NEGATIVE_PERK,
		SPECIES_PERK_ICON = "star-of-life",
		SPECIES_PERK_NAME = "Beastly Stature",
		SPECIES_PERK_DESC = "'GAS' as they are called possess a figure that is unable to utilise most normal clothing."
	))
